...
GO
create procedure [dbo].[create_regular_season_min_max_player_stats] as


-- drop table if exists
if object_id('dbo.regular_season_min_max_player_stats', 'U') is not null
drop table dbo.regular_season_min_max_player_stats; 
...
into dbo.regular_season_min_max_player_stats
from t00
GO
